...
public class ContaCantina {
	...
	public void cadastraLanche(int qtdItens, int valorCentavos, String detalhes) {
		this.itensConsumidos += qtdItens;
		this.debitoConta += valorCentavos;
		this.ultimosDetalhes[controlaDetalhes] = detalhes;
		this.controlaDetalhes++;
		
		if (this.controlaDetalhes == 5) {
			this.controlaDetalhes = 0;
		}
	...
	public void pagaConta(int valorCentavos) {
		if (this.debitoConta > valorCentavos) {
			this.debitoConta -= valorCentavos;
		} else {
			this.debitoConta = 0;
		}
